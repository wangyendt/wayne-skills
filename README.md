...
| `awesome-docs` | [awesome-docs/](awesome-docs/SKILL.md) | Write source-backed technical documents with reader-first structure, precise explanations, and interactive diagrams. |
